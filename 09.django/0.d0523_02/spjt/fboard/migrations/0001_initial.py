    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('f_createdate', models.DateTimeField(blank=True, default=datetime.datetime(2022, 5, 23, 17, 30, 35, 523658))),
                ('f_upedatedate', models.DateTimeField(blank=True, default=datetime.datetime(2022, 5, 23, 17, 30, 35, 523658))),
