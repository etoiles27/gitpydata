...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            model_name='fboard',
            name='f_createdate',
            field=models.DateTimeField(blank=True, default=datetime.datetime(2022, 5, 30, 15, 43, 6, 955964)),
        ),
        migrations.AlterField(
            model_name='fboard',
            name='f_updatedate',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('c_date', models.DateTimeField(blank=True, default=datetime.datetime(2022, 5, 30, 15, 43, 6, 955964))),
