    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('f_createdate', models.DateTimeField(blank=True, default=datetime.datetime(2022, 5, 23, 10, 55, 59, 232485))),
                ('f_upedatedate', models.DateTimeField(blank=True, default=datetime.datetime(2022, 5, 23, 10, 55, 59, 232485))),
