...
def public_list(request):
    ...
    m_serviceKey="t%2FJIY9cPLzrKeXsvafAp3Ub757LxSa%2FHo4gnGvfwwRnPUZaTZn2LR2yVxHMjEcSFfvVL6J6PgqTeR199b5NEFA%3D%3D"
    ...
    contents = res.text
    json_con = json.loads(contents)
    body = json_con['response']['body']['items']
    print(type(json_con),body)
