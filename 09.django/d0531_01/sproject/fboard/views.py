...
def commList(request):
    ...
    # context = {'clist':clist, 'count':qs.count}
...
def commWrite(request):
    ...
    c_no = qs.c_no
    c_date = qs.c_date    
    context={'f_no':f_no, 'c_pw':pw,'c_content':content,'c_no':c_no,'c_date':c_date}
    print(context)
...
def commUpdateOk(request):
    ...
    context={'result':'댓글이 수정되었습니다', 'c_no':c_no,'c_content':c_content}
    return JsonResponse(context)
