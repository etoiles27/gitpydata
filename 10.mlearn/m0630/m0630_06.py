...
s1 = knr.predict([[100]])
distances1, indexs1 = knr.kneighbors([[100]])
print(s)
# plt.scatter(length, weight)
# plt.scatter(50,s[0],color='orange')
# plt.scatter(100,s1[0],color='gray')
# plt.scatter(train_data[indexs], train_label[indexs], color='red')
# plt.scatter(train_data[indexs1], train_label[indexs1], color='black')
